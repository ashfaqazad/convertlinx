...
export default function ImageCropper() {
  ...
  const faqs = [
    ...
    { q: 'Can I crop HEIC photos from my iPhone?', a: 'Yes — upload your HEIC file directly. It will be decoded in your browser so you can crop it and download as JPG, WebP, or PNG. No app or conversion needed first.' },
    ...
    { q: 'Can I crop images for social media platforms?', a: 'Yes — use the preset aspect ratios to crop for Instagram (1:1 or 4:5), YouTube thumbnails (16:9), Twitter/X (16:9), Facebook cover, and Instagram Stories (9:16). One click sets the correct ratio.' },
    { q: 'Is my image uploaded to a server when I crop it?', a: 'No — all cropping happens entirely in your browser. Your image never leaves your device and is never uploaded or stored on any server.' },
    { q: 'Can I crop a PNG image without losing its transparent background?', a: 'Yes — select PNG as the output format before downloading. The crop tool preserves transparency in PNG files so your transparent background stays intact.' },
  ];
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 2, name: 'Image Cropper', item: 'https://convertlinx.com/image-cropper' },
            ],
          }),
        }}
      />
          ...
          <div className="max-w-3xl mx-auto space-y-8" style={{ color: '#6B7280' }}>
            ...
            <div>
              ...
              <p className="leading-7 text-sm">
                ...
                or blank spaces when you upload them.
              </p>
              <p className="leading-7 text-sm mt-3">
                ...
                ratio presets, or type exact pixel dimensions for precise results every time.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="leading-7 text-sm">
                ...
                or resizing after the fact, use the built-in aspect ratio presets to crop your images
                to exactly the right proportions before uploading.
              </p>
            </div>
