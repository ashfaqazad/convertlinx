...
const faqs = [
  ...
  { q: 'What types of QR codes can I create?',
    a: 'URLs, plain text, WiFi passwords, WhatsApp links, email addresses, and contact details — all fully supported.' },
  ...
  { q: 'Does it work on mobile?',
    a: 'Yes — fully optimized for iPhones, Android phones, tablets, and desktop computers. Any modern browser works.' },
  { q: 'Can I create a QR code for WiFi?',
    a: 'Yes — type your WiFi network name and password into the input field in the standard WiFi QR format and download the code. Guests can scan it to connect instantly without typing a password.' },
  { q: 'Are the QR codes scannable by all phones?',
    a: 'Yes — the generated QR codes are compatible with iPhone\'s built-in camera, Android camera apps, and all QR scanner apps. No special app is needed on modern smartphones.' },
  { q: 'Can I create a QR code for WhatsApp?',
    a: 'Yes — enter a WhatsApp link in the format https://wa.me/YOURNUMBER (replace YOURNUMBER with your phone number including country code) and the QR code will open WhatsApp directly when scanned.' },
];
        ...
        <section className="alt-section py-16 px-6">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-5">
              {[
                { icon: <Link className="w-6 h-6" />,         color: '#6366F1', bg: 'rgba(99,102,241,0.08)',  title: 'Any Content Type',      desc: 'URLs, plain text, WiFi passwords, WhatsApp links, email addresses, and contact cards — all fully supported.' },
                { icon: <Wifi className="w-6 h-6" />,         color: '#10B981', bg: 'rgba(16,185,129,0.08)',  title: 'High Quality Output',   desc: 'Sharp high-resolution PNG — perfect for print on posters, flyers, business cards, and packaging. Scans every time.' },
                { icon: <MessageCircle className="w-6 h-6" />, color: '#F59E0B', bg: 'rgba(245,158,11,0.08)', title: 'Private & Unlimited',   desc: 'Unlimited QR codes with no sign-up. Zero data stored or sent to any server — your content stays private.' },
              ].map((b, i) => (
          ...
          <div className="max-w-3xl mx-auto space-y-8" style={{ color: '#6B7280' }}>
            ...
            <div>
              ...
              <p className="leading-7 text-sm">
                ...
                manually save a contact — a single scan does it all instantly. Whether you
                run a restaurant, sell products, host events, or just want to share something
                quickly, a QR code removes every barrier between your audience and your content.
              </p>
              <p className="leading-7 text-sm mt-3">
                ...
                content and the QR code appears live. Download the high-resolution PNG and use
                it anywhere — print, digital, or both.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="leading-7 text-sm">
                ...
                contact information. Modern iPhones and Android phones scan QR codes natively
                with the camera app — no extra app required.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="grid sm:grid-cols-2 gap-3">
                {[
                  'Businesses — cards, flyers, packaging, and storefronts',
                  'Restaurants — digital menus and ordering pages',
                  'Event organizers — tickets, schedules, and info pages',
                  'Students & teachers — share resources and links instantly',
                  'Marketers — link print campaigns to landing pages',
                  'Anyone — fast contactless sharing without typing',
                ].map((item, i) => (
