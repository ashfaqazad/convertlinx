...
const faqs = [
  ...
  { q: 'Which image formats are supported?',
    a: 'JPG, PNG, WebP, and other common image formats supported by your browser are all accepted.' },
  { q: 'How accurate is the OCR?',
    a: 'Very accurate for clear printed text. Blurry images, low resolution, or messy handwriting may reduce accuracy — use the clearest image possible for best results.' },
  { q: 'Can it read handwritten text?',
    a: 'It may work for neat, clean handwriting, but printed text always gives the best results. Try to use high-contrast, well-lit images for handwritten notes.' },
  ...
  { q: 'Can I use this on mobile?',
    a: 'Yes — fully optimized for iPhones, Android phones, tablets, and desktops. Works in any modern browser without installing anything.' },
  { q: 'Can I extract text from a screenshot?',
    a: 'Yes — screenshots work perfectly. Take a screenshot of any text on your screen, upload it to the tool, and the text will be extracted and ready to copy in seconds.' },
  { q: 'Can I extract text from a scanned PDF page?',
    a: 'Yes — if you have a scanned PDF, take a screenshot of the page or export it as an image, then upload it here. The OCR will extract all readable text from the image.' },
  { q: 'What languages does the OCR support?',
    a: 'The tool currently processes English text with high accuracy. For best results, use images containing printed English text with good contrast and resolution.' },
];
...
export default function ImageToText() {
  ...
  return (
    <>
      ...
      <Script id="breadcrumb-schema-img-text" type="application/ld+json" strategy="afterInteractive"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            '@context': 'https://schema.org', '@type': 'BreadcrumbList',
            itemListElement: [
              { '@type': 'ListItem', position: 1, name: 'Home',             item: 'https://convertlinx.com/'                  },
              { '@type': 'ListItem', position: 2, name: 'Image to Text OCR', item: 'https://convertlinx.com/image-to-text'    },
            ],
          }),
        }}
      />
          ...
          <div className="max-w-3xl mx-auto space-y-8" style={{ color: '#6B7280' }}>
            ...
            <div>
              ...
              <p className="leading-7 text-sm">
                ...
                retyping it wastes time and introduces errors. A good OCR tool extracts it
                accurately in seconds, giving you editable, copyable text immediately.
              </p>
              <p className="leading-7 text-sm mt-3">
                This free image to text converter uses Tesseract OCR running entirely in your
                browser — no file is ever sent to a server, and nothing is stored. Upload any
                image, wait a few seconds, and copy the extracted text directly into your
                document, email, or app.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="leading-7 text-sm">
                ...
                background — like printed documents, typed text, or clear screenshots — gives
                near-perfect results. Blurry photos, low resolution, skewed angles, or very
                stylized fonts reduce accuracy. For best results, use images with at least
                150 DPI resolution and good lighting.
              </p>
            </div>
