        ...
        <div className="flex justify-between items-center h-18">
          ...
          <div className="hidden lg:flex items-center space-x-10">
            ...
            <div className="relative group">
              ...
              <div className="absolute top-14 left-1/2 -translate-x-1/2 w-[520px]
      ...
      {mobileOpen && (
        <div className="lg:hidden bg-white border-t border-gray-100">
          <div className="px-6 py-6 space-y-4">
            ...
            <Link href="/" className="block font-semibold text-gray-800 py-2">
              Home
            </Link>
            ...
            <Link href="/blog" className="block font-semibold text-gray-800 py-2">
              Blog
            </Link>

            <Link href="/about" className="block font-semibold text-gray-800 py-2">
              About
            </Link>

            <Link href="/contact" className="block font-semibold text-gray-800 py-2">
              Contact
            </Link>
