export const metadata = {
  title: 'Terms and Conditions | ConvertLinx',
  description: 'Read the terms and conditions for using ConvertLinx tools and services. Free online converter and utility tools for everyone.',
  alternates: {
    canonical: 'https://convertlinx.com/terms-and-conditions',
  },
  openGraph: {
    title: 'Terms and Conditions | ConvertLinx',
    url: 'https://convertlinx.com/terms-and-conditions',
  },
};
...
export default function TermsAndConditions() {
  const jsonLd = {
    ...
    '@type': 'WebPage',
    name: 'Terms and Conditions - ConvertLinx',
    description: 'Read the terms and conditions for using ConvertLinx tools and services.',
    url: 'https://convertlinx.com/terms-and-conditions',
    publisher: {
      '@type': 'Organization',
      name: 'ConvertLinx',
  ...
  return (
    <>
      ...
      <div className="max-w-3xl mx-auto px-6 py-10 text-gray-800 leading-relaxed">
        ...
        <p className="mb-4">
          Welcome to ConvertLinx. By accessing or using our website, you agree to be
        ...
        <p className="mb-4">
          Our online converter and utility tools are provided for personal and
          educational use. You may not use our service for any unlawful, harmful,
          or commercial purpose that violates local or international laws.
        </p>

        <h2 className="text-xl font-semibold mt-6 mb-2">Intellectual Property</h2>
        <p className="mb-4">
          All website content, logos, and design elements are owned by ConvertLinx
        ...
        <p className="mb-4">
          ...
          stored permanently. ConvertLinx does not review, share, or claim ownership
        ...
        <p className="mb-4">
          ...
          warranties of any kind. ConvertLinx makes no guarantees regarding accuracy,
          performance, or uninterrupted availability of the tools.
        </p>

        <h2 className="text-xl font-semibold mt-6 mb-2">Limitation of Liability</h2>
        <p className="mb-4">
          ConvertLinx shall not be held liable for any damages, data loss, or issues
        ...
        <p className="mb-4">
          ...
          personalized advertisements. By using ConvertLinx, you consent to such ad
        ...
        <p className="mb-4">
          ConvertLinx reserves the right to modify or update these Terms and Conditions
        ...
        <p>
          ...
          us at:{' '}
          <span className="font-medium">support@convertlinx.com</span>
        </p>
      </div>
    </>
  );
